...
public class InitialData {
	...
	private void setUserInitialData() {
		users.add(new User(0,"Sam Elleray", "Sam", "Chickens1", "sam@chickens.com", "07881508168", new Date(), true, new Address("12 High Street", "Townhill", "Somerset", "England", "WH1 1t1"), new Date()));
